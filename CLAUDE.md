...
- **Argumentaire Cap Retraite (Bernard)** : `knowledge/pitch-cap-retraite.md` — ⚠️ **périmé, à réécrire** (voir § L'axe du pitch ci-dessous).
...
- ⚠️ **`knowledge/pitch-cap-retraite.md` est périmé** : il porte encore l'angle « vente de leads », le pitch hash et des tarifs. **À réécrire avant le rendez-vous** — ne pas s'en servir comme antisèche en l'état.
