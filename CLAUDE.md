...
**Acte 2 — le pitch en plein écran (06/08).** À la fin du scénario, le bouton principal de la console cesse de proposer « rejouer » et propose **« לחלק השני »** : le dossier glisse hors champ (`grid-template-columns: 1fr 0fr`), le chat prend toute la carte, et Emma **retourne l'outil vers celui qui regarde** — elle vient de qualifier une famille, elle qualifie maintenant son interlocuteur. 17 temps : 5 **questions-leviers** (grosses, liseré d'accent, seules à l'écran), 9 réponses, 2 punchlines pleine largeur, 1 carte de fin. Contenu tiré de `knowledge/pitch-seo.md`, allégé pour être dit à voix haute. Durée **28 s à 1× voix coupée**. Chapitre **9 · החלק השני** dans le sélecteur → répétable sans rejouer la démo.
