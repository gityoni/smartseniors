...
- ~~`knowledge/pitch-cap-retraite.md` v1 (5 pitchs, modèles A/B, pré-check hash)~~ — **remplacé le 29/07** par la version LeadsMagic. Les deux lignes ci-dessous décrivaient la v1 et étaient devenues fausses ; corrigées le 29/07.
